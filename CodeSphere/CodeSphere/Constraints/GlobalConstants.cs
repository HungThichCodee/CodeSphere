namespace CodeSphere.Constraints
{
    public class GlobalConstants
    {
        ...
        public const int FollowersCountOnPage = 5;

        public const int FollowingCountOnPage = 5;
        ...
        public const int TopCategoriesCount = 100;

        public const int TopPostsCount = 10;

        public const int TopTagsCount = 100;

        public const int BlogPostShortContentMaxLength = 347;

        public const string AiGeneratedContentSessionKey = "AiGeneratedContent";
        public const string AiGeneratedTitleSessionKey = "AiGeneratedTitle";
        public const string AiGeneratedEmbeddingSessionKey = "AiGeneratedEmbedding";
        public const string AiGeneratedTopicSessionKey = "AiGeneratedTopic";
    }
}
