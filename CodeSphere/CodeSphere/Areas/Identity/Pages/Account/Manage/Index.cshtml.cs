...
namespace CodeSphere.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (isUpdatePersonalData == true)
            {
                ...
                {
                    Action = UserActionType.EditPersonalData,
            ...
            if (isUpdateCoverImage == true)
            {
                user.UserActions.Add(new UserAction
                {
                    Action = UserActionType.ChangeCoverImage,
                    ActionDate = DateTime.UtcNow,
                    PersonUsername = user.UserName,
                    ProfileImageUrl = user.ImageUrl,
            ...
            if (isUpdateProfileImage == true)
            {
                user.UserActions.Add(new UserAction
                {
                    Action = UserActionType.ChangeProfilePicture,
                    ActionDate = DateTime.UtcNow,
                    PersonUsername = user.UserName,
