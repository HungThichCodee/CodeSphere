...
function createNotification(notification) {
    ...
    // Kiểm tra và sử dụng ảnh mặc định nếu imageUrl null/empty
    let imageUrl = notification.imageUrl && notification.imageUrl.trim() !== '' 
        ? notification.imageUrl 
        : '/images/AnhDaiDien.png';

    // Kiểm tra và xử lý tên người dùng
    let firstName = notification.targetFirstName && notification.targetFirstName.trim() !== '' 
        ? notification.targetFirstName 
        : '';
    let lastName = notification.targetLastName && notification.targetLastName.trim() !== '' 
        ? notification.targetLastName 
        : '';
    let fullName = (firstName + ' ' + lastName).trim();
    
    // Nếu cả firstName và lastName đều rỗng, sử dụng username
    if (fullName === '') {
        fullName = notification.targetUsername || 'Unknown User';
    }
