    ...
    if (message && images.length == 0 && files.length == 0) {
        ...
        if (images.length > 0 || files.length > 0) {
            if (images.length > 0) {
                ...
                let imageIcon = document.querySelector("label[for='uploadImage'] i");
                if (imageIcon) {
                    imageIcon.classList = "";
                    imageIcon.classList.add("fas", "fa-cloud-upload-alt");
                }
            ...
            if (files.length > 0) {
                ...
                let fileIcon = document.querySelector("label[for='uploadFile'] i");
                if (fileIcon) {
                    fileIcon.classList = "";
                    fileIcon.classList.add("fas", "fa-file-upload");
                }
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.haveImages) {
                        ...
                        if (imageIcon) {
                            imageIcon.classList = "";
                            imageIcon.classList.add("far", "fa-images");
                        }
                    ...
                    if (result.haveFiles) {
                        ...
                        if (fileIcon) {
                            fileIcon.classList = "";
                            fileIcon.classList.add("fas", "fa-paperclip");
                        }
