...
namespace CodeSphere.Models.User
{
    public class ApplicationUser : IdentityUser
    {
        public ApplicationUser()
        {
            ...
            this.Following = new HashSet<FollowUnfollow>();
            this.Followers = new HashSet<FollowUnfollow>();
            this.Posts = new HashSet<Post>();
            this.Comments = new HashSet<Comment>();
            this.PostLikes = new HashSet<PostLike>();
            this.FavouritePosts = new HashSet<FavouritePost>();
            this.PendingPosts = new HashSet<PendingPost>();
            this.BlockedPosts = new HashSet<BlockedPost>();
            this.UsersGroups = new HashSet<UserGroup>();
            this.ChatMessages = new HashSet<ChatMessage>();
            this.ChatImages = new HashSet<ChatImage>();
            this.RecommendedFriends = new HashSet<RecommendedFriend>();
            this.UserRecommendations = new HashSet<RecommendedFriend>();
            this.UserNotifications = new HashSet<UserNotification>();
            this.QuickChatReplies = new HashSet<QuickChatReply>();
            this.FavouriteStickers = new HashSet<FavouriteStickers>();
        }
